...
function Hero() {
  ...
  return (
    <div className="boardgamehero">
    <h1 className="hero-title">Tu puerta de entrada a los juegos de Mesa</h1>
    <p className="hero-content">Visita nuestros proyectos activos: </p>
